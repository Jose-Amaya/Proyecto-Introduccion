...
<div id="lastcar" class="d-flex flex-row flex-nowrap card-deck card-columns demcar">      
...
<div id="lastcar2" class="d-flex flex-row flex-nowrap card-deck card-columns demcar">
